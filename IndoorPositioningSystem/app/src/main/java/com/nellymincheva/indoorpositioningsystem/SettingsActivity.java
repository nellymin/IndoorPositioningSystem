...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_beacon_1_y)));

        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_beacon_2_mac)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_beacon_2_x)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_beacon_2_y)));
